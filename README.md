...
- Importante sobre `webhook`: debe ser una URL publica tuya (ejemplo: `https://electronic-items-further-transcripts.trycloudflare.com /api/payments/webhook`).
...
>
> ```txt
> https://electronic-items-further-transcripts.trycloudflare.com /api/payments/webhook
> ```
>
...
curl --request POST \
  ...
  --data '{
    ...
    "webhook": "https://electronic-items-further-transcripts.trycloudflare.com /api/payments/webhook",
    "qr": true
}'
```
