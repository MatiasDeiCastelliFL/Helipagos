...
- Importante sobre `webhook`: debe ser una URL publica tuya (ejemplo: `https://drop-bar-presently-save.trycloudflare.com/api/payments/webhook`).
...
>
> ```txt
> https://drop-bar-presently-save.trycloudflare.com/api/payments/webhook
> ```
>
...
curl --request POST \
  ...
  --data '{
    ...
    "webhook": "https://drop-bar-presently-save.trycloudflare.com/api/payments/webhook",
    "qr": true
}'
```
