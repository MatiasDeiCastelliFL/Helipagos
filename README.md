...
- Importante sobre `webhook`: debe ser una URL publica tuya (ejemplo: `https://birth-fort-bedding-income.trycloudflare.com`).
...
>
> ```txt
> https://birth-fort-bedding-income.trycloudflare.com
> ```
>
...
curl --request POST \
  ...
  --data '{
    ...
    "webhook": "https://birth-fort-bedding-income.trycloudflare.com",
    "qr": true
}'
```
